...
exports.createProject = function (body) {
  return new Promise(function (resolve, reject) {
    ...
    var data = new project({
      ...
      expectedstartDate: new Date('body.expectedstartDate').toISOString(),
      actualstartDate: new Date('body.actualstartDate').toISOString(),
      expectedendDate:  new Date('body.expectedendDate').toISOString(),
